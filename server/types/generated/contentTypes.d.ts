...
export interface ApiAnimeAnime extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    alternative_titles: Schema.Attribute.JSON;
    average_episode_duration: Schema.Attribute.Integer;
    cover: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    current_episodes: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    media_type: Schema.Attribute.String;
    nsfw: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    num_episodes: Schema.Attribute.Integer;
    ...
    studios: Schema.Attribute.Relation<'manyToMany', 'api::studio.studio'>;
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    background: Schema.Attribute.Media<'images' | 'files', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero: Schema.Attribute.Relation<'oneToOne', 'api::hero.hero'>;
